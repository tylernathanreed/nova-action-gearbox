...
trait HasGearboxActions
{
    ...
    public function serializeForIndex(NovaRequest $request, $fields = null)
    {
    	...
    	return array_merge($data, $this->serializeForActionGearbox($request));
    }
    ...
    {
        // Determine the parent serialization
        $data = parent::serializeForDetail($request);
     ...
     * @return array
     */
    public function serializeForActionGearbox(NovaRequest $request)
    {
